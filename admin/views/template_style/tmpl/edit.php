                ...
                <div class="span8 form-horizontal">
                    <fieldset class="adminForm">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#layout" data-toggle="tab"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_LAYOUT');?></a></li>
                            <li><a href="#menus_assignment" data-toggle="tab"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_MENUS_ASSIGNMENT');?></a></li>
                            <li><a href="#categories_assignment" data-toggle="tab"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_CATEGORIES_ASSIGNMENT');?></a></li>
                            <li><a href="#articles_assignment" data-toggle="tab"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_ARTICLES_ASSIGNMENT');?></a></li>
                        </ul>
