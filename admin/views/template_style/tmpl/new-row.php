    ...
    <div class="span12">
        ...
        <div id="<?php echo $parentId?>" class="pull-right row-tools row-container">
            <select class="containertype" name="" aria-invalid="false">
                ...
                <option value="container"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_FIXED_WIDTH');?></option>
                <option value="container-fluid"><?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_FULL_WIDTH');?></option>
            </select>
            <a href="" title="<?php echo JText::_('COM_TZ_PORTFOLIO_PLUS_MOVE_THIS_ROW');?>" class="fa fa-arrows rowmove"></a>
