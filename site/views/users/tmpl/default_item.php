...
// Begin Icon print, Email or Edit
 if ($params->get('show_cat_print_icon', 0) || $params->get('show_cat_email_icon', 0) || $canEdit) :
  ?>
<div class="TzIcon">
...
<?php
if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))):
 if ($params->get('show_user_category',1)
...
<?php echo $item -> event -> contentDisplayListView; ?>
    ...
    <a class="btn btn-default TzReadmore" href="<?php echo $link; ?>"><?php
        echo JText::_('COM_TZ_PORTFOLIO_PLUS_READ_MORE');?></a>
    <?php endif;?>
<?php } ?>
