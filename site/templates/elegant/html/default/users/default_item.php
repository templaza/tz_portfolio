...
if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))):
    ?>
    <div class="tpHead">
    <?php if ($params->get('show_user_print_icon', 0) || $params->get('show_user_email_icon', 0) || $canEdit) : ?>
    <div class="TzIcon">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu">
                <?php if ($params->get('show_user_print_icon', 0)) : ?>
                    <li class="print-icon"> <?php echo JHtml::_('icon.print_popup', $this->item, $params); ?> </li>
                <?php endif; ?>
                <?php if ($params->get('show_user_email_icon', 0)) : ?>
...
<?php endif; ?>
    <?php if ($params->get('show_user_title',1)) : ?>
...
<?php endif; ?>
    <?php if (!$params->get('show_user_intro',1)) : ?>
    <?php
...
<?php endif; ?>
    <?php
    if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))):
        if ($params->get('show_user_author',1) or $params->get('show_user_category',1)
            or $params->get('show_user_create_date',1) or $params->get('show_user_modify_date',0)
            or $params->get('show_user_publish_date',0) or $params->get('show_user_parent_category',0)
            or $params->get('show_user_hits',1) or $params->get('show_user_tags',1)
            ...
            <div class="muted tpMeta">
                ...
                <?php if ($params->get('show_user_create_date', 1)) : ?>
                ...
                <?php endif; ?>
                <?php if ($params->get('show_user_author',1) && !empty($this->item->author )) : ?>
                    <div class="TzBlogCreatedby" itemprop="author" itemscope itemtype="http://schema.org/Person">
                        ...
                        <?php if ($params->get('user_link_author', 1)):?>
                ...
                <?php if ($params->get('show_user_hits', 1)) : ?>
                ...
                <?php if ($params->get('show_user_category',1)) : ?>
                ...
                <?php if ($params->get('show_user_parent_category', 0) && $this -> item->parent_id != 1) : ?>
                ...
                <?php if($params -> get('show_user_tags',1)):
                    echo $this -> loadTemplate('tags');
                endif;
                ?>

                <?php if ($params->get('show_user_publish_date',0)) : ?>
                ...
                <?php if ($params->get('show_user_modify_date',0)) : ?>
        ...
        <div class="tpBody">
            ...
            ?>
            <?php if ($params->get('show_user_readmore',1) && $this->item->readmore) {
