...
if(isset($this -> item) && $this -> item){
    ...
    if($params -> get('show_cat_vote', 0)){
        ...
        if(!$this -> head['layout_'.$this -> getLayout()]) {
            ...
            (function($){
                ...
                $(document).ready(function(){
                    $(".js-tpp-addon-vote__tags").tzPortfolioPlusAddOnVote({
                        mainSelector: ".js-tpp-addon-vote__tags",
        ...
        <div class="content_rating js-tpp-addon-vote__tags"  itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
