...
if(isset($this -> item) && $this -> item){
    ...
    if($params -> get('show_cat_vote', 0)){
        ...
        if(!$this -> head['layout_'.$this -> getLayout()]) {
            ...
            (function($){
                ...
                $(document).ready(function(){
                    $(".blog").tzPortfolioPlusAddOnVote({
                        mainSelector: ".js-tpp-addon-vote",
        ...
        <div class="content_rating muted js-tpp-addon-vote"  itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
