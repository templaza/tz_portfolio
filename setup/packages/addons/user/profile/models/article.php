...
JLoader::import('user.profile.models.portfolio', COM_TZ_PORTFOLIO_PLUS_ADDON_PATH);

class PlgTZ_Portfolio_PlusUserProfileModelArticle extends PlgTZ_Portfolio_PlusUserProfileModelPortfolio {
