...
use TemPlaza\Component\TZ_Portfolio\AddOn\Extrafields\Multipleselect\Extension\Multipleselect;
    ...
    public function register(Container $container)
    {
        ...
        $container->set(
            ...
            function (Container $container) {
                $addon     = new Multipleselect(
                    '',
                    (array) AddonHelper::getAddOn('extrafields', 'multipleselect')
                );
