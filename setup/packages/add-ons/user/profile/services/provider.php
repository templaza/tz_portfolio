...
use TemPlaza\Component\TZ_Portfolio\AddOn\User\Profile\Extension\Profile;
...
return new class () implements ServiceProviderInterface {
    ...
    {
        $container->registerServiceProvider(new MVCFactory('\\TemPlaza\\Component\\TZ_Portfolio\\AddOn\\User\\Profile'));
