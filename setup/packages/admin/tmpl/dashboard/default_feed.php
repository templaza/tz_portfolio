...
if($feeds = $this -> feedBlog) {
    ...
    <div class="tp-widget tp-feed-blog">
        <h4 class="title"><?php echo Text::_('COM_TZ_PORTFOLIO_LATEST_FROM_OUR_BLOG'); ?></h4>
        <ul class="inside">
            ...
            ?>
                <li><a href="<?php echo htmlspecialchars($uri, ENT_COMPAT, 'UTF-8');
                ?>" target="_blank"><?php echo trim($feed -> title); ?></a>
                    <span class="rss-date">
