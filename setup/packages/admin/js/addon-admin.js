jQuery( document ).ready( function( $ ) {
    ...
    $('.tzportfolio-box-responsive .tzportfolio-device').on ('click', function (e) {
    ...
    $('.tzportfolio-box-responsive .tzportfolio-lock>span').on ('click', function (e) {
    ...
    $('.tzportfolio-box-responsive .tzportfolio-box-item>input').on ('input', function (e) {
    ...
    $('.tzfont-container').each(function(i, el) {
        el = $(el);
    ...
    $('.tzportfolio-box-responsive').each(function(i, el) {
        el = $(el);
    ...
    $(document).on('subform-row-add', function(event, row){
        $(row).find('.tzportfolio-box-responsive .tzportfolio-device').on ('click', function (e) {
            $(this).parent().find('.tzportfolio-device').removeClass('active');
            $(this).addClass('active');
            if ($(this).hasClass('md')) {
                switchLock('.md', this);
        ...
        $(row).find('.tzportfolio-box-responsive .tzportfolio-lock>span').on ('click', function (e) {
            if ($(this).find('i').hasClass('icon-locked')) {
                $(this).find('i').removeClass().addClass('icon-unlock');
            } else {
                $(this).find('i').removeClass().addClass('icon-locked');
        ...
        $(row).find('.tzportfolio-box-responsive .tzportfolio-box-item>input').on ('input', function (e) {
            if ($(this).parent().parent().parent().parent().find('.tzportfolio-lock').find('.active').find('i').hasClass('icon-locked')) {
                $(this).parent().parent().find('input').val($(this).val());
            }
        });
        $(row).find('.tzfont-container').each(function(i, el) {
            el = $(el);
        ...
        $(row).find('.tzportfolio-box-responsive').each(function(i, el) {
            el = $(el);
            var base_id = el.find('input.pm-data');
            base_id =   $(base_id).attr('id');
