...
class CategoriesHelper
{
    ...
    public static function getAssociations($pk, $extension = 'com_tz_portfolio')
    {
        $associations = array();
        try{
            $db = Factory::getDbo();
            ...
            $query = $db->getQuery(true)
                ...
                ->join('INNER', '#__associations as a ON a.id = c.id AND a.context=' . $db->quote('com_tz_portfolio.categories.item'))
