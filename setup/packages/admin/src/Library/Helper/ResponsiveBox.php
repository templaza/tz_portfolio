...
class ResponsiveBox{
    ...
    public static function generation($type, $name, $id, $value) {
        ...
        $document = Factory::getApplication() -> getDocument() -> getWebAssetManager();
        $document->useStyle('com_tz_portfolio.addon-admin.style');
        $document->useScript('com_tz_portfolio.addon-admin.script');
