...
class TzcolorField extends FormField
{
    /**
     * The form field type.
     *
    ...
    protected function getInput()
    {
        ...
        if (!self::$initialised)
        {
            Factory::getApplication() -> getDocument() -> addStyleSheet(Uri::root().'/administrator/components/com_tz_portfolio_plus/css/spectrum.min.css', array('version' => 'auto'));
            Factory::getApplication() -> getDocument() -> addScript(Uri::root().'/administrator/components/com_tz_portfolio_plus/js/spectrum.min.js', array('version' => 'auto'));
        ...
        . (!empty($color)?htmlspecialchars($color, ENT_COMPAT, 'UTF-8'):$color) . '" data-extrafield-type="color"' . $hint . $class . $position . $control
