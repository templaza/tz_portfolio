...
//        JTableObserverTags::createObserver($this, array('typeAlias' => 'com_tz_portfolio.article'));
//        JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_tz_portfolio.article'));
    ...
    protected function _getAssetName()
    {
        ...
        return 'com_tz_portfolio.article.' . (int) $this->$k;
    }
    ...
    public function check()
    {
        ...
        if (!$this->id)
        {
            ...
            if (!$this->getRules())
            {
                $rules = $this->getDefaultAssetValues('com_tz_portfolio');
                $this->setRules($rules);
            }
        }
