...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_ARTICLES_BATCH_OPTIONS');?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_ARTICLES_BATCH_TIP'); ?></p>
		...
		<div class="control-group">
			<div class="controls">
				<?php echo HTMLHelper::_('tzbatch.item', 'com_tz_portfolio_plus');?>
			</div>
		</div>
		<?php endif; ?>
	</div>
