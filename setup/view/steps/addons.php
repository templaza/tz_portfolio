...
$(document).ready(function(){
	tpp.ajaxUrl	= "<?php echo Uri::root();?>administrator/index.php?option=com_tz_portfolio_plus&ajax=1";
...
<form name="installation" method="post" data-installation-form>
	...
	<p class="section-desc"><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_SETUP_ADDONS_DESC'); ?></p>

	<div data-addons-retrieving><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_SETUP_ADDONS_RETRIEVING_LIST');?></div>

	<div class="hide" data-addons-progress>
		<div class="install-progress">
			<div class="d-flex">
				<div class="message">
					<div class="hide" data-progress-complete-message><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_SETUP_EXTENSIONS_COMPLETED');?></div>
					<div data-progress-active-message=""><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_SETUP_INSTALLING_MODULES');?></div>
				</div>
				<div class="result text-right">
                    <div class="progress-result">
                        <span data-progress-bar-result="">0%</span>
                        <span><?php echo Text::_('COM_TZ_PORTFOLIO_PLUS_COMPLETED'); ?></span>
                    </div>
				</div>
			</div>
