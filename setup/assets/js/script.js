...
var tpp = {
    ...
    ajaxUrl: "<?php echo \Joomla\CMS\Uri\Uri::root();?>administrator/index.php?option=com_tz_portfolio_plus&ajax=1",
    string: {
        install_complete: "<?php echo TZ_Portfolio_PlusSetupString::jsPlusAddSlashes(\Joomla\CMS\Language\Text::_('COM_TZ_PORTFOLIO_PLUS_SETUP_INSTALLING_COMPLETED'));?>"
    },
